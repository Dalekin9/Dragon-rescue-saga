...
public class Launcher {
    ...
    public static Niveau[] init(){
        ...
        tab[0] = new Niveau(new Grille(new Case[7][7]),1,2,5);
        tab[1] = new Niveau(new Grille(new Case[8][5]),2,5,0);
        tab[2] = new Niveau(new Grille(new Case[9][7]),3,3,0);
        tab[3] = new Niveau(new Grille(new Case[8][9]),4,12,0);
        tab[4] = new Niveau(new Grille(new Case[8][9]),5,5,0);
        return tab;
    }
